...
abstract class AbstractSlider extends AbstractButtonWidget implements IRenderableControl {
    ...
    protected void renderBg(MatrixStack matrices, MinecraftClient minecraft, int mouseX, int mouseY) {
        ...
        this.drawTexture(matrices, this.x + (int) (this.progress * (double) (this.width - 8)), this.y, 0, 66, 4, 20);
        this.drawTexture(matrices, this.x + (int) (this.progress * (double) (this.width - 8)) + 4, this.y, 196, 66, 4, 20);
    }
